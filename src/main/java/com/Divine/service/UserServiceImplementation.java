...
import com.Divine.config.JwtProvider;
import com.Divine.model.PasswordResetToken;
import com.Divine.model.User;
import com.Divine.repository.PasswordResetTokenRepository;
...
//		System.out.println("email user "+user.get().getEmail());
	...
	public void sendPasswordResetEmail(User user) {
		...
		sendEmail(user.getEmail(), "Password Reset", "Click the following link to reset your password: https://divinefoodservice-1.onrender.com/account/reset-password?token=" + resetToken);
	}
